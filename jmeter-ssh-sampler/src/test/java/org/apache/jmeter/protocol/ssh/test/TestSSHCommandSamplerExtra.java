...
public class TestSSHCommandSamplerExtra // extends TestCase
{
	...
	/*
	 * public TestSSHCommandSamplerExtra(String name) { //super(name); }
	 */
	...
	public void testSampleUnkownDestAddress() {
		...
		String responseMessage = sr.getResponseMessage();
		LOG.log(Level.INFO, "response message:" + responseMessage);
		assertTrue("responsemessage is correct", responseMessage
				.equals("Failed to connect to server: timeout: socket is not established")
				|| responseMessage.equals(
						"Failed to connect to server: java.net.NoRouteToHostException: No route to host: connect")
				|| responseMessage.equals(
						"Failed to connect to server: java.net.SocketException: Network is unreachable: connect"));
		String responseData = sr.getResponseDataAsString();
	...
	public void testSampleEmptyStringCommandKeepConnOpen() {
		...
		LOG.log(Level.INFO, "response code:" + responseCode);
		String responseMessage = sr.getResponseMessage();
		assertTrue("responsemessage is correct",
